...
class Breakout:
    def __init__(
        ...
        # Score, Lives & Power-ups
        self.score    = 0
        self.lives    = 3
        self.powerups = []  # initialize the list before using it in tick()
    ...
    def tick(self):
        """One frame: move, check collisions, redraw, reschedule."""
        # Move ball
        self.ball.move()
        bx, by = self.ball.x, self.ball.y

        # Bottom edge: lose life or game over
    ...
    def game_over(self):
        """Display GAME OVER text and stop."""
